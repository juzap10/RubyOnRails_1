...
class PersonasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create persona" do
    assert_difference('Persona.count') do
      post personas_url, params: { persona: { altura: @persona.altura, edad: @persona.edad, peso: @persona.peso } }
    end
  ...
  test "should update persona" do
    patch persona_url(@persona), params: { persona: { altura: @persona.altura, edad: @persona.edad, peso: @persona.peso } }
